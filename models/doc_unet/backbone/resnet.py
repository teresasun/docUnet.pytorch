...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, output_stride, BatchNorm, pretrained=True, model_url=''):
        self.inplanes = 64
...
def resnet34(output_stride, BatchNorm, pretrained=True):
    ...
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = ResNet(BasicBlock, [3, 4, 6, 3], output_stride, BatchNorm, pretrained=pretrained,
                   model_rul=model_urls['resnet18'])
    return model
...
def resnet101(output_stride, BatchNorm, pretrained=True):
    ...
    model = ResNet(Bottleneck, [3, 4, 23, 3], output_stride, BatchNorm, pretrained=pretrained,
                   model_rul=model_urls['resnet101'])
    return model
...
if __name__ == "__main__":
    ...
    model = resnet152(BatchNorm=nn.BatchNorm2d, pretrained=True, output_stride=8)
